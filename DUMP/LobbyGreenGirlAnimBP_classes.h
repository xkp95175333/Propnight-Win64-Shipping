...
struct ULobbyGreenGirlAnimBP_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function LobbyGreenGirlAnimBP.LobbyGreenGirlAnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x132e1a0
	void EvaluateGraphExposedInputs_ExecuteUbergraph_LobbyGreenGirlAnimBP_AnimGraphNode_TransitionResult_995C9D894E73DF6419207C89F247781C(); // Function LobbyGreenGirlAnimBP.LobbyGreenGirlAnimBP_C.EvaluateGraphExposedInputs_ExecuteUbergraph_LobbyGreenGirlAnimBP_AnimGraphNode_TransitionResult_995C9D894E73DF6419207C89F247781C // (BlueprintEvent) // @ game+0x132e1a0
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function LobbyGreenGirlAnimBP.LobbyGreenGirlAnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x132e1a0
	void ExecuteUbergraph_LobbyGreenGirlAnimBP(int32_t EntryPoint); // Function LobbyGreenGirlAnimBP.LobbyGreenGirlAnimBP_C.ExecuteUbergraph_LobbyGreenGirlAnimBP // (Final|UbergraphFunction) // @ game+0x132e1a0
};
